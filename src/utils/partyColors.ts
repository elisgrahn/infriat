...
export const statusColors: Record<string, string> = {
  'Infriat': 'data-[state=on]:bg-emerald-700 data-[state=on]:hover:bg-emerald-800',
  'Delvis infriat': 'data-[state=on]:bg-emerald-400 data-[state=on]:hover:bg-emerald-500',
  'Pågående': 'data-[state=on]:bg-amber-500 data-[state=on]:hover:bg-amber-600',
  'Försenat': 'data-[state=on]:bg-rose-400 data-[state=on]:hover:bg-rose-500',
  'Brutet': 'data-[state=on]:bg-rose-700 data-[state=on]:hover:bg-rose-800',
  'Oklart': 'data-[state=on]:bg-purple-500 data-[state=on]:hover:bg-purple-600',
};
